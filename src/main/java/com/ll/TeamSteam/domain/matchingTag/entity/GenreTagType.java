...
public enum GenreTagType {
    ...
    액션RPG("액션RPG"), 어드벤처RPG("어드벤처RPG"), 전략RPG("전략RPG"), 현대RPG("현대RPG"), 파티("파티"), 군사("군사"), 대전략("대전략"), 도시("도시"), 실시간전략("실시간전략"), 카드("카드"),
    타워디펜스("타워디펜스"), 턴제전략("턴제전략"), 매트로베니아("매트로베니아"), 비주얼노벨("비주얼노벨"), 캐주얼("캐주얼"), 퍼즐("퍼즐"), 풍부한스토리("풍부한스토리"), 히든오브젝트("히든오브젝트"),
