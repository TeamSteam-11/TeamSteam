...
public class QFriend extends EntityPathBase<Friend> {
    ...
    private static final long serialVersionUID = 724086791L;
    ...
    public final com.ll.TeamSteam.domain.user.entity.QUser friend;
    ...
    public QFriend(Class<? extends Friend> type, PathMetadata metadata, PathInits inits) {
        ...
        this.friend = inits.isInitialized("friend") ? new com.ll.TeamSteam.domain.user.entity.QUser(forProperty("friend"), inits.get("friend")) : null;
